...
const ProjectCard = ({ id, imgUrl, title, subtitle, description, tag, link, date }: ProjectCardProps) => {
    return (
        ...
        <div className="">
            ...
            <div className="flex flex-col py-8  justify-center mb-20 rounded-xl hover:bg-green-400/20">
                ...
                <div className="grid grid-cols-12 relative">
                    ...
                    <div className="col-span-10">
                        ...
                        <div className="grid grid-cols-2">
                            ...
                            {/* Data */}
                            <div className="flex-col col-span-3 md:col-span-3 lg:col-span-1 mr-8">
                               
                                    <h5 className="flex mb-0.1 flex-wrap max-w-[400px] text-start text-md sm:text-lg lg:text-2xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-emerald-700">{title}</h5>
                                    <h5 className="flex mb-2 flex-wrap max-w-[400px] text-start text-sm sm:text-lg lg:text-xl text-gray-200 font-semibold">{subtitle}</h5>
