...
const projectData = [
    {
        ...
        description: `A personal project aimed at learning and expanding my skills with Typescript, React, NextJs, Tailwind, ThreeJS and Framer Motion.`,
        descriptionLine2: `I began with a Figma wireframe, created a theme and styling system, and built out each component from the ground up. Coming from a design background and teaching myself to code, this site is a testament to my ability to rapidly acquire new skills and adapt to dynamic challenges.`,
        ...
        <section id="Projects" className="flex min-h-screen">
            <Container>
                ...
                <div className="flex flex-wrap">
                    <h2 className="font-extrabold text-2xl mx-4 py-2 mt-20 mb-2 text-white justify-start">My Projects</h2>
                </div>
